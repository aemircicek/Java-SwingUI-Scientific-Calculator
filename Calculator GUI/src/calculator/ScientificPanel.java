...
public class ScientificPanel extends JPanel {
	...
	public JButton btnsqr, btnsqroot, btncube, btncuberoot, btndivby1, btnpow, btnyrootx, btnfactorial, btnln, btnlogyx,
			btnepowx, btntenpowx, btnsin, btncos, btntan, btnabs;
			...
			public void actionPerformed(ActionEvent e) {
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
							|| CalculatorLogic.command == 4 || CalculatorLogic.command == 5
							|| CalculatorLogic.command == 6 || CalculatorLogic.command == 7)) {
						...
						if (CalculatorLogic.isValid) {
							...
							if (cmnd == 17 && (normalizedAngle == 90 || normalizedAngle == 270)) {
								...
								if (number2 == Math.floor(number2)) {
									displayPanel.getField().setText(label + "(" + displayPanel.getField().getText()
											+ (int) number2 + ")" + " =");
								} else {
									displayPanel.getField().setText(
											label + "(" + displayPanel.getField().getText() + number2 + ")" + " =");
								}
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (CalculatorLogic.isFirst) {
						...
						if (number1 == Math.floor(number1)) {
							...
							if (label.equals("xʸ")) {
								displayPanel.getField()
										.setText(displayPanel.getField().getText() + (int) number1 + " ^ ");
							} else if (label.equals("ʸ√x")) {
								displayPanel.getField()
										.setText(displayPanel.getField().getText() + (int) number1 + " ^ " + "(1 / x)");
							}
						} else {
							if (displayPanel.getField().getText().contains("=")) {
								displayPanel.getField().setText("");
							...
							if (label.equals("xʸ")) {
								...
								displayPanel.getField()
										.setText(displayPanel.getField().getText() + number1 + " ^ " + "(1 / x)");
							}
						}
						...
						if (number2 == Math.floor(number2)) {
							...
							if (label.equals("xʸ")) {
								...
								displayPanel.getField()
										.setText(displayPanel.getField().getText() + number2 + " ^ " + "(1 / x)");
							}
						}
					}
					CalculatorLogic.command = cmnd;
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (number2 == Math.floor(number2)) {
								displayPanel.getField().setText(
										"(" + displayPanel.getField().getText() + (int) number2 + ")" + "²" + " =");
							} else {
								displayPanel.getField()
										.setText("(" + displayPanel.getField().getText() + number2 + ")" + "²" + " =");
							}
							if (CalculatorLogic.result == Math.floor(CalculatorLogic.result)) {
								displayPanel.getTextField()
										.setText(String.valueOf((int) Math.pow(CalculatorLogic.result, 2)));
							} else {
								displayPanel.getTextField()
										.setText(String.valueOf(Math.pow(CalculatorLogic.result, 2)));
							}
						}
					}
						...
						if (CalculatorLogic.isValid) {
							if (CalculatorLogic.result < 0) {
								...
								if (number2 == Math.floor(number2)) {
									...
									displayPanel.getField().setText(
											"√" + "(" + displayPanel.getField().getText() + number2 + ")" + " =");
								}
								if (CalculatorLogic.result == Math.floor(CalculatorLogic.result)) {
									displayPanel.getTextField()
											.setText(String.valueOf((int) Math.sqrt(CalculatorLogic.result)));
								} else {
									displayPanel.getTextField()
											.setText(String.valueOf(Math.sqrt(CalculatorLogic.result)));
								}
							}
						}
					}
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							...
							if (CalculatorLogic.result == Math.floor(CalculatorLogic.result)) {
								displayPanel.getTextField()
										.setText(String.valueOf((int) Math.pow(CalculatorLogic.result, 3)));
							} else {
								displayPanel.getTextField()
										.setText(String.valueOf(Math.pow(CalculatorLogic.result, 3)));
							}
						}
					}
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							...
							if (CalculatorLogic.result == Math.floor(CalculatorLogic.result)) {
								displayPanel.getTextField()
										.setText(String.valueOf((int) Math.cbrt(CalculatorLogic.result)));
							} else {
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (CalculatorLogic.result == 0) {
								...
								if (number2 == Math.floor(number2)) {
									displayPanel.getField().setText("1 / " + "(" + displayPanel.getField().getText()
											+ (int) number2 + ")" + " =");
								} else {
									displayPanel.getField().setText(
											"1 / " + "(" + displayPanel.getField().getText() + number2 + ")" + " =");
								}
								if (1 / CalculatorLogic.result == Math.floor(1 / CalculatorLogic.result)) {
									displayPanel.getTextField()
											.setText(String.valueOf((int) (1 / CalculatorLogic.result)));
								} else {
			...
			public void actionPerformed(ActionEvent e) {
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (CalculatorLogic.result < 0
									|| CalculatorLogic.result != Math.floor(CalculatorLogic.result)) {
								displayPanel.getTextField().setText("Invalid Input!");
								displayPanel.getField().setText("");
								CalculatorLogic.isValid = false;
							} else {
								...
								if (CalculatorLogic.factorial(CalculatorLogic.result) == Math
										.floor(CalculatorLogic.factorial(CalculatorLogic.result))) {
									displayPanel.getTextField().setText(
											String.valueOf((int) CalculatorLogic.factorial(CalculatorLogic.result)));
								} else {
									displayPanel.getTextField()
											.setText(String.valueOf(CalculatorLogic.factorial(CalculatorLogic.result)));
								}
							}
						}
					}
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (CalculatorLogic.result <= 0) {
								...
								if (number2 == Math.floor(number2)) {
									displayPanel.getField().setText(
											"ln(" + displayPanel.getField().getText() + (int) number2 + ")" + " =");
								} else {
									displayPanel.getField()
											.setText("ln(" + displayPanel.getField().getText() + number2 + ")" + " =");
								}
								if (CalculatorLogic.result == Math.floor(CalculatorLogic.result)) {
									displayPanel.getTextField()
											.setText(String.valueOf(Math.log(CalculatorLogic.result)));
								} else {
									displayPanel.getTextField()
											.setText(String.valueOf(Math.log(CalculatorLogic.result)));
								}
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (number1 <= 1) {
						...
						if (CalculatorLogic.isFirst) {
							...
							if (number2 == Math.floor(number2)) {
								displayPanel.getField().setText(
										"(base (" + displayPanel.getField().getText() + (int) number2 + "))log");
							} else {
								displayPanel.getField()
										.setText("(base (" + displayPanel.getField().getText() + number2 + "))log");
							}
							displayPanel.getTextField().setText("0");
						}
					}
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (number2 == Math.floor(number2)) {
								displayPanel.getField().setText(
										"e ^ " + "(" + displayPanel.getField().getText() + (int) number2 + ")" + " =");
							} else {
								displayPanel.getField().setText(
										"e ^ " + "(" + displayPanel.getField().getText() + number2 + ")" + " =");
							}
							if (Math.exp(CalculatorLogic.result) == Math.floor(Math.exp(CalculatorLogic.result))) {
								displayPanel.getTextField()
										.setText(String.valueOf((int) Math.exp(CalculatorLogic.result)));
							} else {
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (number2 == Math.floor(number2)) {
								displayPanel.getField().setText(
										"10 ^ " + "(" + displayPanel.getField().getText() + (int) number2 + ")" + " =");
							} else {
								displayPanel.getField().setText(
										"10 ^ " + "(" + displayPanel.getField().getText() + number2 + ")" + " =");
							}
							if (Math.pow(10, CalculatorLogic.result) == Math
									.floor(Math.pow(10, CalculatorLogic.result))) {
								displayPanel.getTextField()
										.setText(String.valueOf((int) Math.pow(10, CalculatorLogic.result)));
							} else {
								displayPanel.getTextField()
										.setText(String.valueOf(Math.pow(10, CalculatorLogic.result)));
							}
						}
					}
				...
				if (displayPanel.getTextField().getText().equals("")
					...
					if (!(CalculatorLogic.command == 1 || CalculatorLogic.command == 2 || CalculatorLogic.command == 3
						...
						if (CalculatorLogic.isValid) {
							if (number2 == Math.floor(number2)) {
								displayPanel.getField()
										.setText("|" + displayPanel.getField().getText() + (int) number2 + "|" + " =");
							} else {
								displayPanel.getField()
										.setText("|" + displayPanel.getField().getText() + number2 + "|" + " =");
							}
							if (CalculatorLogic.result == Math.floor(CalculatorLogic.result)) {
								displayPanel.getTextField()
										.setText(String.valueOf((int) Math.abs(CalculatorLogic.result)));
							} else {
